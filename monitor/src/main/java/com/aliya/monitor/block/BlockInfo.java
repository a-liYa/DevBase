...
public class BlockInfo {
    ...
    static {
        ...
        sQualifier = BlockCanary.sContext.provideQualifier();
//        try {
//            TelephonyManager telephonyManager = (TelephonyManager) BlockCanary.sContext
//                    .provideContext()
...
//        }
    ...
    public static BlockInfo newInstance() {
        ...
        Context context = BlockCanary.sContext.provideContext();
        ...
        blockInfo.uid = BlockCanary.sContext.provideUid();
        blockInfo.processName = ProcessUtils.myProcessName();
        blockInfo.network = BlockCanary.sContext.provideNetworkType();
